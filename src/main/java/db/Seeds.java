...
public class Seeds {
    ...
    public static void seedData() {
        ...
        Article article3 = new Article("Super Upul set to return to Glasgow", "Students revolt to bring back super Upul", "Super Upul is set to make a comeback to the Glasgow Campus of CodeClan following an uproar from Glasgow's G5 class. The decision was made to bring him back after instructors Alan, Ally and Alistair got sick of the Super Upul emoji on Slack", new GregorianCalendar(2016, 7, 12), Categorisation.CURRENT_AFFAIRS, journalist1);
